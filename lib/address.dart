class Address{
  ...
  static String getRevenueStatistics = '/revenue-statistics';
  static String getOrderDetail = '/order_details/';
  static String downloadInvoice = '/export_invoice/';
  static String revenue = '/revenue-month';
